...
include (struct
  type 'a array  = 'a Array.    t [@@deriving sexp, typerep]
  type bool      = Bool.        t [@@deriving compare, sexp, typerep]
  type char      = Char.        t [@@deriving compare, sexp, typerep]
  type float     = Float.       t [@@deriving compare, sexp, typerep]
  type int       = Int.         t [@@deriving compare, sexp, typerep]
  type int32     = Int32.       t [@@deriving compare, sexp, typerep]
  type int64     = Int64.       t [@@deriving compare, sexp, typerep]
  type 'a lazy_t = 'a Core_lazy.t [@@deriving compare, sexp, typerep]
  type 'a list   = 'a List.     t [@@deriving sexp, typerep]
  type nativeint = Nativeint.   t [@@deriving compare, sexp, typerep]
  type 'a option = 'a Option.   t [@@deriving sexp, typerep]
  type string    = String.      t [@@deriving compare, sexp, typerep]
  type 'a ref    = 'a Ref.      t [@@deriving sexp, typerep]
  type unit      = Unit.        t [@@deriving compare, sexp, typerep]

  (* Bin_prot has optimized functions for float arrays *)
  type float_array = float array
  (* Bin_prot.Std.float_array *)
  include (struct
  ...
  type 'a array  [@@deriving sexp, typerep]
  type bool      [@@deriving compare, sexp, typerep]
  type char      [@@deriving compare, sexp, typerep]
  type float     [@@deriving compare, sexp, typerep]
  type int       [@@deriving compare, sexp, typerep]
  type int32     [@@deriving compare, sexp, typerep]
  type int64     [@@deriving compare, sexp, typerep]
  type 'a lazy_t [@@deriving sexp, typerep]
  type 'a list   [@@deriving sexp, typerep]
  type nativeint [@@deriving compare, sexp, typerep]
  type 'a option [@@deriving sexp, typerep]
  type string    [@@deriving compare, sexp, typerep]
  type 'a ref    [@@deriving sexp, typerep]
  type unit      [@@deriving compare, sexp, typerep]

  type float_array = float array [@@deriving compare, sexp, typerep]
end
...
(* The below declarations define converters for the special types recognized by pa-sexp.
   ...
   type t = { foo : int sexp_option } [@@deriving sexp, compare]
...
*)
type 'a sexp_array  = 'a array  [@@deriving compare, typerep]
type sexp_bool      = bool      [@@deriving compare, typerep]
type 'a sexp_list   = 'a list   [@@deriving compare, typerep]
type 'a sexp_option = 'a option [@@deriving compare, typerep]

type 'a sexp_opaque = 'a        [@@deriving compare, typerep]
