...
type nobody [@@deriving compare, sexp]
type me     [@@deriving compare, sexp]
...
module Export : sig
  (** We don't expose [bin_io] for [write] due to a naming conflict with the functions
      ...
      [Write.t]. *)
  type read       = Read.          t [@@deriving compare, sexp]
  type write      = Write.         t [@@deriving compare, sexp]
  type immutable  = Immutable.     t [@@deriving compare, sexp]
  type read_write = Read_write.    t [@@deriving compare, sexp]
  type 'a perms   = 'a Upper_bound.t [@@deriving compare, sexp]
end

module Stable : sig
  module V1 : sig
    type nonrec nobody = nobody [@@deriving compare, sexp]
    type nonrec me     = me     [@@deriving compare, sexp]
